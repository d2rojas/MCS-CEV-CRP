...
# AWS Deployment Script for Green Construction MCS-CEV Optimization System
# ======================================================================
...
print_status $BLUE "🚀 AWS Deployment Script for Green Construction"
echo "=================================================="
...
ECR_REPOSITORY="green-construction-mcs-optimization"
APP_RUNNER_SERVICE="green-construction-service"
...
print_status $YELLOW "Step 3: Building and tagging Docker image..."
...
print_status $BLUE "   4. Access your application via the provided URL"
echo ""
