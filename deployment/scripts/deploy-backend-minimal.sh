...
# AWS Deployment Script for Green Construction MCS-CEV Optimization Backend API (Minimal Version)
# =============================================================================================
...
print_status $BLUE "🚀 AWS Backend API Deployment Script (Minimal Version)"
echo "====================================================="
...
# Step 2: Build and tag image using the minimal Dockerfile
print_status $YELLOW "Step 2: Building and tagging Docker image (minimal version)..."
docker build -f Dockerfile.backend-minimal -t $ECR_REPOSITORY .
...
# Step 4: Update App Runner service with longer health check timeout
print_status $YELLOW "Step 4: Updating App Runner service with minimal image..."
...
print_status $GREEN "✅ App Runner service updated with minimal image and longer health check timeout"
...
print_status $GREEN "🎉 Minimal Backend API Deployment completed!"
echo ""
...
echo ""
print_status $YELLOW "🔧 Key improvements in minimal version:"
print_status $YELLOW "   - Based on node:18-slim (faster startup)"
print_status $YELLOW "   - Longer health check timeout (30s instead of 5s)"
print_status $YELLOW "   - Longer start period (120s instead of 60s)"
print_status $YELLOW "   - More retries (5 instead of 3)"
print_status $YELLOW "   - Julia installed but not precompiled (faster startup)"
